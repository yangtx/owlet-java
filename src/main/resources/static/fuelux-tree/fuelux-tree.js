( function( $ ) {
		...
		function styleNodeSelected( $element, $icon ) {
			...
			if ( $element.data( 'type' ) === 'item' && $icon.hasClass( 'fa-file' ) ) {
				$icon.removeClass( 'fa-file' ).addClass( 'fa-file-text' ); // make checkmark
			}
		}

		function styleNodeDeselected( $element, $icon ) {
			$element.removeClass( 'tree-selected' );
			if ( $element.data( 'type' ) === 'item' && $icon.hasClass( 'fa-file-text' ) ) {
				$icon.removeClass( 'fa-file-text' ).addClass( 'fa-file' ); // make bullet
			}
		}
